  ...
  const steps = [
    {
      ...
      description: 'Hubungkan wallet EVM Anda untuk memulai',
      color: 'purple',
    },
    {
      icon: Vote,
    ...
    },
    {
      ...
      number: '03',
      title: 'Vote & Verify',
      description: 'Kirim vote dan verifikasi transaksi di blockchain',
      color: 'green',
    },
  ];
    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          <div className="hidden md:block absolute top-1/2 left-0 right-0 h-1 bg-gradient-to-r from-purple-600 via-blue-600 to-green-600 -translate-y-1/2 z-0 opacity-70" />
        ...
        <div className="text-center mt-16">
          ...
          {!isConnected && (
            <p className="text-sm text-gray-500 dark:text-slate-400 mt-4">
              Wallet akan diminta saat Anda melanjutkan
            </p>
          )}
        </div>
      </div>
